 ...
 * @export
 */
shaka.player.Player.prototype.getVideo = function() {
  return this.video_;
};


/**
 * Returns player's video source.
 * @return {shaka.player.IVideoSource}
 * @export
 */
shaka.player.Player.prototype.getVideoSource = function() {
...
shaka.player.Player.prototype.load = function(videoSource) {
  ...
  return loaded.then(shaka.util.TypedBind(this,
      ...
      function() {
        ...
        var attachPromise = this.videoSource_.attach(this, this.video_);
