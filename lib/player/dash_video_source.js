...
/**
 * Provides manifest URL of dash video source.
 * @return {string}
 * @export
 */
shaka.player.DashVideoSource.prototype.getUrl = function() {
  return this.mpdUrl_;
};


/**
 * Expose manifest details for outer world.
 * @return {shaka.media.ManifestInfo}
 * @export
 */
shaka.player.DashVideoSource.prototype.getManifestInfo = function() {
