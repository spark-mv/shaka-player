...
goog.require('shaka.util.HolaApi');
 ...
 * @export
 */
shaka.Player.version = 'v2.3.3-hola-uncompiled';
...
/**
 * @return {?shakaExtern.Manifest} If a manifest is loaded, returns parsed
 * manifest info loaded from manifestUri.  Otherwise, returns null.
 * @export
 */
shaka.Player.prototype.getManifestInfo = function() {
...
shaka.Player.prototype.initialize_ = function() {
  ...
  shaka.util.HolaApi.shakaMessage({id: 'attach',
    player: this, video: this.video_});
